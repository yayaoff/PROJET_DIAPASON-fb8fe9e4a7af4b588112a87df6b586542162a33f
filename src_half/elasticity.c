...
void get_boundary_nodes (size_t** bnd_nTags, size_t* bnd_nTags_n, size_t** sym_nodes, size_t* n_sym_nodes){
...
int assemble_system_half(Matrix** K, Matrix** M, double** coord, size_t** boundary_nodes, size_t* n_boundary_nodes, double E, double nu, double rho,size_t** sym_nodes, size_t* n_sym_nodes){
  ...
  get_boundary_nodes(boundary_nodes, n_boundary_nodes, sym_nodes,  n_sym_nodes); // the position in the matrix is at bnd_nodes[i]-1
